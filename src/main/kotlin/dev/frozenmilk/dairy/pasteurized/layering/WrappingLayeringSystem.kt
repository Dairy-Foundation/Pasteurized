 ...
 */
class WrappingLayeringSystem (private val list: MutableList<PasteurizedGamepad<EnhancedDoubleSupplier, EnhancedBooleanSupplier>>) : IncrementingLayeringSystem<Int> {
	init {
		list.forEach {
			attachGamepad(it)
		}
